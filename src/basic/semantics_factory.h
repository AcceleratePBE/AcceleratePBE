...
class CircuitBinary: public Z3InterpretableSemantics {
public:
    CircuitBinary(std::string name): Z3InterpretableSemantics({TBOOL, TBOOL}, TBOOL, name) {}
...
class CircuitNot: public Z3InterpretableSemantics {
public:
    CircuitNot(): Z3InterpretableSemantics({TBOOL}, TBOOL, "not") {}
