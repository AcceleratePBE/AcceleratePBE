...
(define-fun ResFun ((name String)) String (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (Str (SubStr name (Int 1) (Pos name "Alphanumeric" 0 1))) (Str ".")) (SubStr name (Pos name "Alphanumeric" 1 0) (Pos name "Alphanumeric" 1 1))) (Str ".")) (SubStr name (Pos name "Alphanumeric" 2 0) (Pos name "Alphanumeric" 2 1))) (Str ".")) (SubStr name (Pos name "Alphanumeric" 3 0) (Pos name "Alphanumeric" 3 1))))
