...
(define-fun ResFun ((_arg_0 String)) String (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (Str (SubStr _arg_0 (Int 0) (Int 2))) (Str " ")) (SubStr _arg_0 (Int 4) (Pos _arg_0 "Alphanumeric" 2 1))) (Str " ")) (SubStr _arg_0 (Pos _arg_0 "Alphanumeric" 3 0) (Pos _arg_0 "Alphanumeric" 3 1))) (Str " ")) (SubStr _arg_0 (Pos _arg_0 "Alphanumeric" 4 0) (Pos _arg_0 "Alphanumeric" 4 1))))
