...
(define-fun ResFun ((name String)) String (str.++ (str.++ (str.++ (str.++ (Str (SubStr name (Int 0) (Int 2))) (Str ".")) (SubStr name (Int 4) (Pos name "Alphanumeric" 1 1))) (Str ".")) (SubStr name (Pos name "Alphanumeric" 2 0) (Pos name "Alphanumeric" 2 1))))
